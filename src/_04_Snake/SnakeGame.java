...
Location newLoc= new Location(xvalue.nextInt(WIDTH),yvalue.nextInt(HEIGHT));

while(snake.isLocationOnSnake(newLoc)) {
	newLoc= new Location(xvalue.nextInt(WIDTH),yvalue.nextInt(HEIGHT));
}
foodLocation= newLoc;
