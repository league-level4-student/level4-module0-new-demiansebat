...
public class IntroToEnums {
	...
	public static void main(String[] args) {
		...
		String state= JOptionPane.showInputDialog("Enter a state of matter!");
...
StatesOfMatter randomState;
int randy;
randy= new Random().nextInt(3);
randomState=states[randy];

		// 11. Print outs both of its temperatures.
		System.out.println(randomState.getCelsiusTemp());
		System.out.println(randomState.getFahrenheitTemp());
